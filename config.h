...
static char *fonts[] = {
    "JetBrainsMono NF:style=bold:size=11:antialias=true:autohint=true",
...
static const Key keys[] = {
	...
	{ Mod1Mask,         	XK_space,	spawn,		SHCMD(TERMINAL " -e tmux new-session ~/.local/bin/tmux-sessionizer") },
	...
	{ MODKEY|ControlMask|ShiftMask,		XK_Return,	settagpath,	{0} },

	{ MODKEY,			XK_z,		incrgaps,	{.i = +3 } },
	/* { MODKEY|ShiftMask,		XK_z,		spawn,		SHCMD("") }, */
	{ MODKEY,			XK_x,		incrgaps,	{.i = -3 } },
	/* { MODKEY|ShiftMask,		XK_x,		spawn,		SHCMD("") }, */
	{ MODKEY|ControlMask,	XK_v,		spawn,		{.v = (const char*[]){ "toggle_vpn", NULL } } },
